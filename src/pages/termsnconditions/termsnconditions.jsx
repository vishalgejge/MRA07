    ...
    <section className="text-gray-700 body-font">
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="prose max-w-none">
          ...
          <p>&nbsp;</p>
          <p className="pl-5">
            This website is operated by <strong>ATONEKLICK</strong>. Throughout the site, the terms “we”, “us” and “our” refer
            to <strong>ATONEKLICK</strong>. <strong>ATONEKLICK</strong> offers this website, including all information, tools and
          ...
          <p className="pl-5 pt-3">
            ...
            or province of residence, or that you are the age of majority in your state or province of residence and
          ...
          <p className="pl-5">
            ...
            contacting the e-mail and/or billing address/phone number provided at the time the order was made. We reserve
          ...
          <p className="pt-3 pl-5">
            (i) to spam, phish, pharm, pretext, spider, crawl, or scrape; (j) for any obscene or immoral purpose; or (k) to interfere with or circumvent the security features of the Service or any related website, other websites, or the Internet. We reserve the right to terminate your use of the Service or any related website for violating any of the prohibited uses.
          </p>
        ...
        <p> </p>
        <p className="pl-5">
        You agree to indemnify, defend and hold harmless ATONEKLICK and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
        </p>
        <p> </p>
        <p className="pl-5">
        ...
        <p> </p>
        <p className="pt-4 pl-5">
        Questions about the Terms of Service should be sent to us at <p>
        <a href="mailto:support@maharashtrarentagreement.com" className='text-blue-900 font-bold'>support@maharashtrarentagreement.com</a></p>
        </p>
        </div>
      </div>
      </div>
