  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!querySnapshot.empty) {
        const userId = userID;
        await updateDoc(doc(adminsCollection, userId), {
          ...
          <form noValidate onSubmit={handleSubmit} className="row g-2">
            <div className="col-lg-4">
              <div>
                <label
                  ...
                  className="form-label text-slate-800 font-medium"
                >
                  Old Password*
                </label>
                <input
            ...
            <div className="col-lg-12">
              <div className="text-end">
                <button
                  type="submit"
                  className="bg-stone-400 py-2 px-3 rounded-sm text-white font-medium"
                >
                  Change Password
                </button>
              </div>
