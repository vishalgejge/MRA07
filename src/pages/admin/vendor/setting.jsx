...
import PersonalDetails from "./setting-content/PersonalDetails";
  ...
  return (
    <>
      <div className=" border-b border-gray-200 dark:border-gray-700 bg-white">
        ...
        >
          <li className="me-2" role="presentation">
            <button
              className={`inline-block rounded-t-lg border-b-2 border-transparent p-4 text-sky-800 hover:border-gray-300 hover:text-gray-600 dark:hover:text-sky-800 ${activeTab === "profile" ? "border-gray-300 text-slate-800" : ""
                }`}
          ...
          <li className="me-2" role="presentation">
            <button
              className={`inline-block rounded-t-lg border-b-2 border-transparent p-4 text-sky-800 hover:border-gray-300 hover:text-slate-800 dark:hover:text-gray-300 ${activeTab === "profile" ? "border-gray-300 text-gray-600" : ""
                }`}
              id="profile-tab-example"
              type="button"
              role="tab"
              aria-controls="profile-example"
              aria-selected={activeTab === "personalDetails"}
      ...
      <div id="tabContentExample">
        <div
          className={`rounded-lg bg-white p-4 dark:bg-gray-800 flex gap-4 ${activeTab === "profile" ? "" : "hidden"
            }`}
          id="profile-example"
          role="tabpanel"
        ...
        >
          <label htmlFor="profile-image" className="relative cursor-pointer">
            {profileImageUrl ? (
              ...
              <div className="rounded-full w-96 h-96 bg-white flex items-center justify-center">
                <svg
                ...
                >
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth="2"
                    d="M15 8a6 6 0 00-6 6H4a8 8 0 008-8z"
                  />
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    strokeWidth="2"
                    d="M20 12v0a8 8 0 01-8 8"
                  />
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    strokeWidth="2"
                    d="M4 12v0a8 8 0 008 8"
                  />
                </svg>
              </div>
            )}
          ...
          />
          <button
            className={` bg-sky-800 h-10 inline-block align-middle p-2 mt-5 text-white rounded ${activeTab === "settings" ? "border-gray-300 text-gray-600" : ""
              }`}
        ...
        <div
          className={`rounded-lg bg-white p-4 dark:bg-gray-800 ${activeTab === "personalDetails" ? "" : "hidden"
            }`}
        ...
        >
          <p className="text-sm text-gray-500 dark:text-gray-400">
            This is some placeholder content for the Contacts tab's associated
